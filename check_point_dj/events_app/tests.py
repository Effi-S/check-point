...
class URLTests(TestCase):
    ...
    def test_events_sanity(self):
        ...
        response = self.client.post('/api/v1/events', data='This is a test')
    ...
    def test_stats_sanity(self):
        ...
        """
        self.client.post('/api/v1/events', data='This is a test')
    ...
    def test_stats_correct_tally(self):
        ...
        # --2-- post messages
        for msg in messages:
            self.client.post('/api/v1/events', data=msg)
        ...
        self.assertEquals(response.body, expected)
